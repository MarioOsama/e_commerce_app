...
class SettingsItemListTileWithTrailingIcon extends StatelessWidget {
  const SettingsItemListTileWithTrailingIcon({
    super.key,
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      trailing: const RotatedBox(
          quarterTurns: 2, child: Icon(Icons.arrow_back_ios_new_outlined)),
    );
  }
}
